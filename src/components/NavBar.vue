<template>
    <header>
      <nav class="navbar navbar-expand-md navbar-dark bg-dark">
        <div class="container">
          <a class="navbar-brand" href="https://github.com/minusone523/minusone523.github.io">Tool Colections</a>
          ...
          <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <ul v-else class="navbar-nav me-auto mb-2 mb-md-0">
              ...
              <li class="nav-item">
                <router-link class="nav-link" to="/diff">Diff</router-link>
              </li>
              <li class="nav-item">
                <router-link class="nav-link" to="/tools">Tools</router-link>
              </li>
              <li class="nav-item">
                <router-link class="nav-link" to="/json">Json</router-link>
              </li>
              <li class="nav-item">
